 ...
 *
 * The 70/30 weights and 30-day age ceiling are an explicit reversible
 * implementation default, not canon. Later synthetic selection/tuning evidence
 * may revise them without changing the scoring interface.
 *
