...
| C06 | IN_REVIEW | combat | 2063ad8 | feat/v2-combat-leave | GPT-5.6 Sol | pending CI/review | NO | deterministic LEAVE/fail-forward rules | pending | draft PR #58 | C07,C13 |
...
| K06 | MERGED | knowledge | 2063ad8 | feat/v2-knowledge-gap-retirement | GPT-5.6 Sol | static review + GitHub Actions | NO | user do-not-explore retirement action | docs/v2/proof/K06.md | PR #52 merged as f351765; integration #221 pending | K07 |
| K03 | IN_REVIEW | knowledge | 2063ad8 | feat/v2-knowledge-structural-relevance | GPT-5.6 Sol | pending CI/review | YES only on relevance ambiguity | provenance-only contradiction/confirmed-change relevance; no drama weighting | pending | draft PR #57 | K07 |
...
| P01 | MERGED | provider | 2063ad8 | feat/v2-journal-proposal-schema | GPT-5.6 Sol | proposal-authority review + GitHub Actions | NO | JournalProposal schema | docs/v2/proof/P01.md | PR #53 merged as b262901; integration #221 pending | J09,P05 |
